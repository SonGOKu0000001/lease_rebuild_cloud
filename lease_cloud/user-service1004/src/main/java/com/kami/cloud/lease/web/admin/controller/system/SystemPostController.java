package com.kami.cloud.lease.web.admin.controller.system;
...
import com.kami.cloud.lease.model.entity.SystemPost;
import com.kami.cloud.lease.model.enums.BaseStatus;
import com.baomidou.mybatisplus.core.metadata.IPage;
import com.kami.cloud.lease.web.admin.service.SystemPostService;
...
public class SystemPostController {
    ...
    public Result removeById(@RequestParam Long id) {
        if(service.getById(id) == null) {
            throw new LeaseException(ResultCodeEnum.ADMIN_POST_NOT_EXIST_ERROR);
        }
