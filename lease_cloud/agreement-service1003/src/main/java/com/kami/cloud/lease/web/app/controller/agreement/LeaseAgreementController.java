package com.kami.cloud.lease.web.app.controller.agreement;
...
public class LeaseAgreementController {
    ...
    public Result<List<AgreementItemVo>> listItem() {
        List<AgreementItemVo> result = service.listItemByUsername(LoginUserHolder.getLoginUser().getUsername());
